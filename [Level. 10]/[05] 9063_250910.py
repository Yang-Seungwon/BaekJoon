"""
문제:  임씨는 1950 년 한국전쟁으로 많은 손해를 본 사람들 중 하나다.
      ...
      임씨는 즉시 민사소송을 통해 자신의 땅을 찾고자 했고 논리적인 근거를 들어 옥구슬이 나오는 지점이 원래 자신의 땅의 한 지점이었다는 것을 주장하여
      결국 담당판사를 설득하는 데에 성공하였다. 담당판사는 다음과 같은 판결을 내렸다.
...
입력: 첫째 줄에는 점의 개수 N (1 ≤ N ≤ 100,000) 이 주어진다.
